...
def add_shortlist():
    ...
    if final:
        return redirect(url_for('view_hoservice.search_service', message='Service successfully added to shortlist'))
    else:
        return redirect(url_for('view_hoservice.search_service', message='Service already shortlisted'))
